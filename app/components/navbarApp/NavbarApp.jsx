...
const navigation = [
  { name: 'Matches', href: '/matches', current: false, icon: PeopleIcon },
  { name: 'Notifiche', href: '/notification', current: false, icon: NotifyIcon },
  { name: 'Profilo', href: '/profile', current: false, icon: ProfileIcon },
]
